export const en = {
  ...
  language: "English",
  languagePrompt:
    "Speak and respond only in Persian. It is crucial that you maintain your responses in Persian. If the user speaks in other languages, you should still respond in Persian.",
};
